            ...
            <table class="horizontal_form">
                <tr>
                    <td>
                        ...
                        <input type="text" name="c_id" id="c_id" class="text" style="width:50px; text-transform:capitalize" value="" />
                    </td>
                    <td>
                        <label for="f_fname">First name</label>
                        <input type="text" name="f_fname" id="f_fname" class="text" style="width:125px; text-transform:capitalize" value="" />
                    </td>
                    <td>
                        <label for="f_sname">Surname</label>
                        <input type="text" name="f_sname" id="f_sname" class="text" style="width:125px; text-transform:capitalize" value="" />
                    </td>
                    <td>
                        <label for="f_date_of_birth">Date of birth</label>
                        <input type="text" name="f_date_of_birth" id="f_date_of_birth" class="text datepicker" />
                    </td>
                    <td><input type="image" src="/img/btn/add-new.png" id="add_family_member" alt="Add new" /></td>
                    <td><img src="/img/icons/ajax.gif" alt="Loading..." id="loading" style="display:none;" /></td>
                </tr>
            </table>
