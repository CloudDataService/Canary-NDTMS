...
$(document).ready(function () {
	...
	multi_add.init({
		"select": "select#internal_services",
		"add": ".action-add-internal-service",
		"list": "ul.j2is",
		"multi_add_hidden_field": "j2is"
	});
	
	agency_add.init({
		"select": "select#agencies_involved",
		"valfield": "input#ag_start_date",
		"add": ".action-add-agency-involved",
		"list": "ul.j2ag",
		"hidden_field": "j2ag"
	});
